...
- 分支：`main`
- commit：`76b6e71`（后续以 `git log` 为准）
- 应用版本：`v20260822.085314`
- Service Worker：`rabbittodo-v105`
...
- 底栏是 56px（另加安全区）的全宽普通导航；安全区外上、下留白分别为 4px、2px，待办、已办按钮触控区为 56 × 44px，中间有 44px 主题色圆形新增按钮，我的页不显示新增按钮。

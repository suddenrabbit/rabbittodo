...
- 当前 2.6 本地开发基线：commit `b264186`，应用版本 `v20260823.003009`，Service Worker `rabbittodo-v113`。`migrations/0010_account_task_sort_mode.sql` 已在本地与生产 D1 应用。
